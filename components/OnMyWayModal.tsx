...
export function OnMyWayModal({ customer, onClose }: OnMyWayModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* Modal Header */}
        <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-bold text-base text-slate-900">Send "On My Way"</h2>
        ...
        <div className="p-5 space-y-4 overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-2">
              {(['10-15 mins', '5 mins', '20-30 mins', 'Just arrived'] as const).map((timeOption) => (
                <button
                  ...
                  className={`py-2 px-2.5 rounded-xl text-xs font-semibold text-left transition-all border ${
                    eta === timeOption
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all resize-none"
            />
          </div>

          <div className="bg-sky-50 rounded-xl p-3 text-[11px] text-sky-800 leading-relaxed flex items-start gap-2 border border-sky-100">
